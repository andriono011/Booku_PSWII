...
//Apply Coupon
Route::post('/carts/apply-coupon', 'ProductController@applyCoupon');

Route::get('/feedback', 'FeedbackController@index')->name('review');
Route::post('/feedback/proses', 'FeedbackController@addFeedback');
...
Route::group(
	...
	function () {
		...
		Route::match(['get','post'], 'view_coupons', 'CouponsController@viewCoupons');

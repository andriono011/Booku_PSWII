...
<aside class="left-sidebar bg-sidebar">
	<div id="sidebar" class="sidebar sidebar-with-footer">
		...
		<div class="app-brand">
			...
			<span class="brand-name"><b>Booku Shop</b></span>
			</a>
		</div>
					...
					<ul  class="collapse  {{ ($currentAdminMenu == 'catalog') ? 'show' : ''}}"  id="catalog"
						...
						<div class="sub-menu">
							<li  class="{{ ($currentAdminSubMenu == 'product') ? 'active' : ''}}">
								...
								<span class="nav-text">Produk Buku</span>
								</a>
							</li>
							...
							<li class="{{ ($currentAdminSubMenu == 'attribute') ? 'active' : ''}}">
								...
								<span class="nav-text">Atribut Buku</span>
								</a>
							</li>
						</div>
					</ul>
...
<!-- Coupons Sidebar -->
<li  class="has-sub {{ ($currentAdminMenu == 'coupons') ? 'expand active' : ''}}">
					<a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#coupons"
						aria-expanded="false" aria-controls="coupons">
						<i class="mdi mdi-gift"></i>
						<span class="nav-text">Kupon</span> <b class="caret"></b>
					</a>
					<ul class="collapse {{ ($currentAdminMenu == 'coupons') ? 'show' : ''}}"  id="coupons"
						data-parent="#sidebar-menu">
						<div class="sub-menu">
							<li  class="{{ ($currentAdminSubMenu == 'add_coupon') ? 'active' : ''}}" >
								<a class="sidenav-item-link" href="{{ url('admin/add_coupon')}}">
								<span class="nav-text">Tambah Kupon</span>
								</a>
							</li>
							<li  class="{{ ($currentAdminSubMenu == 'view_coupon') ? 'active' : ''}}" >
								<a class="sidenav-item-link" href="{{ url('admin/view_coupons')}}">
								<span class="nav-text">Lihat Kupon</span>
								</a>
							</li>
						</div>
					</ul>
				...
				<li  class="has-sub {{ ($currentAdminMenu == 'order') ? 'expand active' : ''}}">
					<a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#orders"
						...
						<span class="nav-text">Orderan</span> <b class="caret"></b>
					</a>
					<ul class="collapse {{ ($currentAdminMenu == 'order') ? 'show' : ''}}"  id="orders"
						...
						<div class="sub-menu">
							...
							<li class="{{ ($currentAdminSubMenu == 'trashed-order') ? 'active' : ''}}">
								...
								<span class="nav-text">Hapus Orderan</span>
								</a>
							</li>
					...
					<ul class="collapse {{ ($currentAdminMenu == 'general') ? 'show' : ''}}"  id="general"
						...
						<div class="sub-menu">
							<li  class="{{ ($currentAdminSubMenu == 'slide') ? 'active' : ''}}" >
								...
								<span class="nav-text">Slide Gambar</span>
								</a>
							</li>
						</div>
					</ul>
				...
				<li  class="has-sub {{ ($currentAdminMenu == 'role-user') ? 'expand active' : ''}}">
					<a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#auth"
						...
						<span class="nav-text">Users &amp; Pengizinan</span> <b class="caret"></b>
					</a>

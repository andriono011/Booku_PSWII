...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('themes/ezone/assets/css/main.css') }}">
        <link rel="stylesheet" href="{{ asset('themes/ezone/assets/css/style_c.css') }}">
    ...
    <body>
        ...
        <script src="{{ asset('themes/ezone/assets/js/main_j.js') }}"></script>

@if ($slides)
	<div class="slider-area">
		<div class="slider-active owl-carousel">
			...
			<div class="single-slider-4 slider-height-4 bg-img" style="background-image: url({{ asset('storage/'. $slide->original) }})">
				<div class="container">
					<div class="row">
						<div class="ml-auto col-lg-6">
							<div class="furniture-content fadeinup-animated">
								<h2 class="animated" style="color:#808080;">{!! $slide->title !!}</h2>
								<p class="animated" style="color:#808080;">{{ $slide->body }}</p>

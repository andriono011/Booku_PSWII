...
class OrderController extends Controller
{
	...
	public function doCancel(Request $request, $id)
	{
		...
		\Session::flash('success', 'Pesanan telah dibatalkan');
	...
	public function destroy($id)
	{
		...
		if ($order->trashed()) {
			...
			if ($canDestroy) {
				\Session::flash('success', 'Pesanan telah dihapus secara permanen');
			} else {
				\Session::flash('success', 'Pesanan tidak dapat dihapus secara permanen');
			}
			...
			if ($canDestroy) {
				\Session::flash('success', 'Pesanan telah dihapus');
			} else {
	...
	public function restore($id)
	{
		...
		if ($canRestore) {
			\Session::flash('success', 'Pesanan telah dipulihkan');
			return redirect('admin/orders');
		} else {
			if (!\Session::has('error')) {
				\Session::flash('error', 'Pesanan tidak dapat dipulihkan');
			}
			return redirect('admin/orders/trashed');
		}
	}

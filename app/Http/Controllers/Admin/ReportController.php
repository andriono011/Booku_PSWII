...
class ReportController extends Controller
{
	...
	public function revenue(Request $request)
	{
		...
		if ($startDate && !$endDate) {
			\Session::flash('error', 'Tanggal akhir diperlukan jika tanggal mulai ada');
			return redirect('admin/reports/revenue');
		}

		if (!$startDate && $endDate) {
			\Session::flash('error', 'Tanggal mulai diperlukan jika tanggal akhir ada');
			return redirect('admin/reports/revenue');
		}
		...
		if ($startDate && $endDate) {
			...
			if ($diff >= 31) {
				\Session::flash('error', 'Jumlah hari dalam rentang tanggal harus lebih rendah atau sama dengan 31 hari');
				return redirect('admin/reports/revenue');
			}
		} else {
	...
	public function product(Request $request)
	{
		...
		GROUP BY OI.product_id, OI.name, OI.isbn, PI.qty
		";
